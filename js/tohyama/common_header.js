...
// ハンバーガーメニューの画像をdiv構造に変更
CommonHeader.innerHTML = '<div class="container"><a href="https://gamboo.jp/"><img src="/images/tohyama/tohyama_index_2024/gamboo_logo.png" class="gamboo_logo"></a><div class="hamburger" id="ignite"><span class="hamburger-bar"></span><span class="hamburger-bar"></span><span class="hamburger-bar"></span></div></div>';
    ...
    if (typeof mytrans !== 'function') {
        window.mytrans = function(){
            for(let mynum = 1; mynum < 10; mynum++){
                let mysection = document.querySelectorAll(`[name^='section_`+mynum+`']`);
                ...
                const texts = mysection.length > 2 ? Array.from(mysection[2].children) : [];
                ...
                buttons.forEach((button, i) => {
                    button.addEventListener("click", ()=> {
                        ...
                        if (texts.length > 0) texts.forEach(text => text.style.display = "none");
